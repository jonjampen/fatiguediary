...
[
    ...
    'how-fd-text' => 'Fatigue Diary works in your Browser or can be installed <a href="index.php?page=install">here</a>. A detailed tutorial on how to use Fatigue Diary is available <a href="views/intro/' . $_SESSION['settings']['language'] . '/Dashboard.php">here</a>. <br> Fatigue Diary can be used as a diary for patients with Fatigue and can help them with pacing. <br> Enter your energy level after every activity and the app will create a chart that displays your energy throughout the day. Other charts help you to compare days or months with each other. <br> This app was created by Jon Jampen - a fatigue patient - as a project for school.',
